...
class BiteAcquisitionInference:
    ...
    def detect_items(self, image):
        ...
        for i in range(len(labels)):
            label = labels[i]
            if 'noodle' in label or 'mashed' in label or 'risotto' in label or 'oatmeal' in label:
        ...
        for i in range(len(detections)):
            ...
            if 'noodle' in labels[i] or 'mashed' in labels[i] or 'risotto' in labels[i] or 'oatmeal' in labels[i]:
